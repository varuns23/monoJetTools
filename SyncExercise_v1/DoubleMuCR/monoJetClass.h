...
public :
  ...
  virtual bool JetVetoDecision(vector<int> jetCand, int leading_lep_index, int subleading_lep_index);
 vector<int> muon_veto_tightID(int jet_index, float muPtCut);
  ...
  virtual vector<int> pho_veto_looseID(int leading_mu_index, int subleading_mu_index, float phoPtCut);
  virtual vector<int> tau_veto(int leading_mu_index, int subleading_mu_index);
  virtual vector<int> bjet_veto(int leading_mu_index, int subleading_mu_index); 
