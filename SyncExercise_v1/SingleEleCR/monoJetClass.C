...
void monoJetClass::Loop(Long64_t maxEvents, int reportEvery) {
  ...
  for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++) {
	...
	if(pfMET > 50.){
	  ...
	  if (lepMET_MT < 160.){
	    ...
	    bool isoJet = JetVetoDecision(jetCand, lepindex);
	    if(jetCand.size()>0){
	      nJetCand++;
  ...
  h_cutflow->SetBinContent(6,nJetCand);
  h_cutflow->SetBinContent(7,nMinDphiJR);
  h_cutflow->SetBinContent(8,npfCaloCut);
  h_cutflow->SetBinContent(9,nMuVeto);
  h_cutflow->SetBinContent(10,nPhoVeto);
  h_cutflow->SetBinContent(11,nTauVeto);
  h_cutflow->SetBinContent(12,nBtagVeto);
  h_cutflow->SetBinContent(13,nRecoil);
}
...
void monoJetClass::BookHistos(const char* outputFilename) {
  ...
  h_cutflow->GetXaxis()->SetBinLabel(6,"JetCand");
  h_cutflow->GetXaxis()->SetBinLabel(7,"minDPhiJR");
  h_cutflow->GetXaxis()->SetBinLabel(8,"pfcaloCut");
  h_cutflow->GetXaxis()->SetBinLabel(9,"muVeto"); 
  h_cutflow->GetXaxis()->SetBinLabel(10,"phoVeto");
  h_cutflow->GetXaxis()->SetBinLabel(11,"tauVeto");
  h_cutflow->GetXaxis()->SetBinLabel(12,"btagVeto");
  h_cutflow->GetXaxis()->SetBinLabel(13,"Recoil");
}
...
bool monoJetClass::JetVetoDecision(vector<int> jetCand, int lep_index) {
