...
public :
  ...
  virtual int  pho_looseID(float phoPtCut);
  virtual int  pho_tightID(int loose_pho, float phoPtCut);
  virtual bool JetVetoDecision(int jetindex, int lep_index);
  virtual bool ele_veto_looseID(int jet_index, int lep_index,float elePtCut);
