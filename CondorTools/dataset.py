...
if __name__ == '__main__':
    datalist = ['egamma',"egamma_farmout",'singleele','singleele_farmout','singlepho',"singlepho_farmout",'met','met_farmout','signal','zjets_nlo','zjets','wjets_nlo','wjets','dyjets_nlo','dyjets','gjets','st','ttjets','ewk','qcd']
