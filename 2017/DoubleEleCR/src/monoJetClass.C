...
void monoJetClass::BookHistos(const char* outputFilename) {
  ...
  cutflow = new Cutflow({"Total Events", "Two Loose Ele", "One Tight Ele", "Opp Charge", "ZMass",
          "MET Filters", "Muon Veto","Photon Veto","Tau Veto","BJet Veto","mindPhiJetMET","dPFCaloMET","Recoil","Jet Selection","Triggers"});
