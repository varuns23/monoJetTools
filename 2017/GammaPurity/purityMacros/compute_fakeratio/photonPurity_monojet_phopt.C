...
string event_bin_names[8] = {"230to250","250to280","280to320","320to375","375to425","425to475","475to550","550toInf"};
// void plot_sideband_purity(int i, int j, float full_lumi){
void plot_sideband_purity(int i, float full_lumi){
  string event_bin = event_bin_names[i-1];
  cout<< " running for " + event_bin + " bin "<<endl;
  ...
  TFile *f_bkgTemplate = new TFile("rootFiles/bkgTemplate_photonPurity_2017.root");
  TFile *f_dataTemplate = new TFile("rootFiles/dataTemplate_photonPurity_2017.root");
  TFile *f_signalGJets_40to100 = new TFile("rootFiles/signalTemplate_gjets_40to100_2017.root");
  TFile *f_signalGJets_100to200 = new TFile("rootFiles/signalTemplate_gjets_100to200_2017.root");
  TFile *f_signalGJets_200to400 = new TFile("rootFiles/signalTemplate_gjets_200to400_2017.root");
  TFile *f_signalGJets_400to600 = new TFile("rootFiles/signalTemplate_gjets_400to600_2017.root");
  TFile *f_signalGJets_600toInf = new TFile("rootFiles/signalTemplate_gjets_600toInf_2017.root");

  // TString histoname_num_QCD = TString("h_sieie_num_QCD_"+event_bin+"_"+sys_bin);
  TString histoname_ = TString("h_phoPFIso_"+event_bin);
  TH1D * signalGJets_40to100  = (TH1D*)f_signalGJets_40to100 ->Get(histoname_);
  TH1D * signalGJets_100to200 = (TH1D*)f_signalGJets_100to200->Get(histoname_);
  TH1D * signalGJets_200to400 = (TH1D*)f_signalGJets_200to400->Get(histoname_);
  TH1D * signalGJets_400to600 = (TH1D*)f_signalGJets_400to600->Get(histoname_);
  TH1D * signalGJets_600toInf = (TH1D*)f_signalGJets_600toInf->Get(histoname_);
  
  TH1D * data = (TH1D*)f_dataTemplate->Get(histoname_);
  TH1D * bkg = (TH1D*)f_bkgTemplate->Get(histoname_);
  
  signalGJets_40to100 ->Scale(1.862e+04*full_lumi*1000.0/5570870.0);
  signalGJets_100to200->Scale(8.622e+03*full_lumi*1000.0/9961399.0);
  signalGJets_200to400->Scale(2.193e+03*full_lumi*1000.0/1973483.0);
  signalGJets_400to600->Scale(2.585e+02*full_lumi*1000.0/5543397.0);
  signalGJets_600toInf->Scale(8.521e+01*full_lumi*1000.0/4355210.0);
  signalGJets_40to100->Add(signalGJets_100to200);
  signalGJets_40to100->Add(signalGJets_200to400);
  signalGJets_40to100->Add(signalGJets_400to600);
  signalGJets_40to100->Add(signalGJets_600toInf);
  ...
  signalGJets_40to100->GetXaxis()->SetTitle("Photon Isolation");
  signalGJets_40to100->GetYaxis()->SetTitle("Yield for 41.5 fb^{-1}");
  signalGJets_40to100->GetYaxis()->SetTitleOffset(1.8);
  signalGJets_40to100->SetTitle("");
  signalGJets_40to100->SetStats(0);
  signalGJets_40to100->SetLineWidth(2);
  signalGJets_40to100->SetLineColor(kRed);
  
  data->GetXaxis()->SetTitle("Photon Isolation");
  data->GetYaxis()->SetTitle("Yield for 41.5 fb^{-1}");
  ...
  data->GetXaxis()->SetLabelSize(0.040);
  data->GetXaxis()->SetTitleFont(42);
  data->GetXaxis()->SetTitleSize(0.045);
  data->GetYaxis()->SetLabelFont(42);
  data->GetYaxis()->SetLabelSize(0.040);
  data->GetYaxis()->SetTitleFont(42);
  data->GetYaxis()->SetTitleSize(0.045);
  
  TH1F* h_bkg_remainder = (TH1F*)data->Clone("h_bkg_remainder");
  h_bkg_remainder->Add(signalGJets_40to100,-1.0); // Subtract signalGJets_40to100 from sieie_num_QCDsideband_data
  h_bkg_remainder->SetLineColor(kGreen);
  
  for(int i = 1; i <= h_bkg_remainder->GetNbinsX(); i++){
    if(h_bkg_remainder->GetBinContent(i) < 9.0e-7)
      h_bkg_remainder->SetBinContent(i,9.0e-7);
    if(signalGJets_40to100->GetBinContent(i) < 1.0e-7)
      signalGJets_40to100->SetBinContent(i,1.0e-7);
    if(data->GetBinContent(i) < 1.0e-6)
      data->SetBinContent(i,1.0e-6);
  }
 ...
 // if (highPt == "250") upper_limit = 7000.0; // good
 // else if (highPt == "280") upper_limit = 5000.0; // good
 // else if (highPt == "320") upper_limit = 1500.0; // good
 // else if (highPt == "375") upper_limit = 800.0;
 // else if (highPt == "425") upper_limit = 250.0;
 // else if (highPt == "475") upper_limit = 150.0;
 // else if (highPt == "550") upper_limit = 100.0;
 // else if (lowPt == "550") upper_limit = 70.0;
 // signalGJets_40to100->GetYaxis()->SetRangeUser(0.0,upper_limit);
  signalGJets_40to100->Draw("HIST");
  h_bkg_remainder->Draw("HIST SAME");
  data->Draw("SAME 0 E1");
  ...
  leg->AddEntry(data,"Data","P E1");
  leg->AddEntry(signalGJets_40to100,"Signal #gamma+jets MC","L");
  leg->AddEntry(h_bkg_remainder,"Fake template","L");
  leg->SetFillStyle(0);
  leg->Draw();
...
std::vector<Float_t> run_template_fit(int i, int j, float full_lumi)
{
  ...
  TH1D *signalGJets_40to100 = (TH1D*)GJets_40to100->Get(histoname_num_QCD);
  TH1D *signalGJets_100to200 = (TH1D*)GJets_100to200->Get(histoname_num_QCD);
  TH1D *signalGJets_200to400 = (TH1D*)GJets_200to400->Get(histoname_num_QCD);
  TH1D *signalGJets_400to600 = (TH1D*)GJets_400to600->Get(histoname_num_QCD);
  TH1D *signalGJets_600toInf = (TH1D*)GJets_600toInf->Get(histoname_num_QCD);
  signalGJets_40to100->Scale(20730.0*full_lumi*1000.0/4269126.0);
  signalGJets_100to200->Scale(9226.0*full_lumi*1000.0/5131808.0);
  signalGJets_200to400->Scale(2300.0*full_lumi*1000.0/10036339.0);
  signalGJets_400to600->Scale(277.4*full_lumi*1000.0/2435892.0);
  signalGJets_600toInf->Scale(93.38*full_lumi*1000.0/2117687.0);
  signalGJets_40to100->Add(signalGJets_100to200);
  signalGJets_40to100->Add(signalGJets_200to400);
  signalGJets_40to100->Add(signalGJets_400to600);
  signalGJets_40to100->Add(signalGJets_600toInf);
  ...
  if (j == 7 || j == 8){
    ...
    TH1D *signalGJets_40to100_central = (TH1D*)GJets_40to100->Get(TString("h_sieie_num_QCD_"+event_bin+"_0"));
    TH1D *signalGJets_100to200_central = (TH1D*)GJets_100to200->Get(TString("h_sieie_num_QCD_"+event_bin+"_0"));
    TH1D *signalGJets_200to400_central = (TH1D*)GJets_200to400->Get(TString("h_sieie_num_QCD_"+event_bin+"_0"));
    TH1D *signalGJets_400to600_central = (TH1D*)GJets_400to600->Get(TString("h_sieie_num_QCD_"+event_bin+"_0"));
    TH1D *signalGJets_600toInf_central = (TH1D*)GJets_600toInf->Get(TString("h_sieie_num_QCD_"+event_bin+"_0"));
    signalGJets_40to100_central->Scale(20730.0*full_lumi*1000.0/4269126.0);
    signalGJets_100to200_central->Scale(9226.0*full_lumi*1000.0/5131808.0);
    signalGJets_200to400_central->Scale(2300.0*full_lumi*1000.0/10036339.0);
    signalGJets_400to600_central->Scale(277.4*full_lumi*1000.0/2435892.0);
    signalGJets_600toInf_central->Scale(93.38*full_lumi*1000.0/2117687.0);
    signalGJets_40to100_central->Add(signalGJets_100to200_central);
    signalGJets_40to100_central->Add(signalGJets_200to400_central);
    signalGJets_40to100_central->Add(signalGJets_400to600_central);
    signalGJets_40to100_central->Add(signalGJets_600toInf_central);
    TH1D *signalGJets_40to100_sieieUp;
    TH1D *signalGJets_40to100_sieieDown;
    if (j == 7){
      signalGJets_40to100_sieieUp = (TH1D*)signalGJets_40to100->Clone("signalGJets_40to100_sieieUp");
    }
    else {
      signalGJets_40to100_sieieUp = (TH1D*)GJets_40to100->Get(TString("h_sieie_num_QCD_"+event_bin+"_7"));
      TH1D *signalGJets_100to200_sieieUp = (TH1D*)GJets_100to200->Get(TString("h_sieie_num_QCD_"+event_bin+"_7"));
      TH1D *signalGJets_200to400_sieieUp = (TH1D*)GJets_200to400->Get(TString("h_sieie_num_QCD_"+event_bin+"_7"));
      TH1D *signalGJets_400to600_sieieUp = (TH1D*)GJets_400to600->Get(TString("h_sieie_num_QCD_"+event_bin+"_7"));
      TH1D *signalGJets_600toInf_sieieUp = (TH1D*)GJets_600toInf->Get(TString("h_sieie_num_QCD_"+event_bin+"_7"));
      signalGJets_40to100_sieieUp->Scale(20730.0*full_lumi*1000.0/4269126.0);
      signalGJets_100to200_sieieUp->Scale(9226.0*full_lumi*1000.0/5131808.0);
      signalGJets_200to400_sieieUp->Scale(2300.0*full_lumi*1000.0/10036339.0);
      signalGJets_400to600_sieieUp->Scale(277.4*full_lumi*1000.0/2435892.0);
      signalGJets_600toInf_sieieUp->Scale(93.38*full_lumi*1000.0/2117687.0);
      signalGJets_40to100_sieieUp->Add(signalGJets_100to200_sieieUp);
      signalGJets_40to100_sieieUp->Add(signalGJets_200to400_sieieUp);
      signalGJets_40to100_sieieUp->Add(signalGJets_400to600_sieieUp);
      signalGJets_40to100_sieieUp->Add(signalGJets_600toInf_sieieUp);
    }
    if (j == 8){
      signalGJets_40to100_sieieDown = (TH1D*)signalGJets_40to100->Clone("signalGJets_40to100_sieieDown");
    }
    else {
      signalGJets_40to100_sieieDown = (TH1D*)GJets_40to100->Get(TString("h_sieie_num_QCD_"+event_bin+"_8"));
      TH1D *signalGJets_100to200_sieieDown = (TH1D*)GJets_100to200->Get(TString("h_sieie_num_QCD_"+event_bin+"_8"));
      TH1D *signalGJets_200to400_sieieDown = (TH1D*)GJets_200to400->Get(TString("h_sieie_num_QCD_"+event_bin+"_8"));
      TH1D *signalGJets_400to600_sieieDown = (TH1D*)GJets_400to600->Get(TString("h_sieie_num_QCD_"+event_bin+"_8"));
      TH1D *signalGJets_600toInf_sieieDown = (TH1D*)GJets_600toInf->Get(TString("h_sieie_num_QCD_"+event_bin+"_8"));
      signalGJets_40to100_sieieDown->Scale(20730.0*full_lumi*1000.0/4269126.0);
      signalGJets_100to200_sieieDown->Scale(9226.0*full_lumi*1000.0/5131808.0);
      signalGJets_200to400_sieieDown->Scale(2300.0*full_lumi*1000.0/10036339.0);
      signalGJets_400to600_sieieDown->Scale(277.4*full_lumi*1000.0/2435892.0);
      signalGJets_600toInf_sieieDown->Scale(93.38*full_lumi*1000.0/2117687.0);
      signalGJets_40to100_sieieDown->Add(signalGJets_100to200_sieieDown);
      signalGJets_40to100_sieieDown->Add(signalGJets_200to400_sieieDown);
      signalGJets_40to100_sieieDown->Add(signalGJets_400to600_sieieDown);
      signalGJets_40to100_sieieDown->Add(signalGJets_600toInf_sieieDown);
    }
    
    int maxbin = sieie_num_GJets_40to100_central->GetMaximumBin();
    int maxbin_QCDsideband = signalGJets_40to100_central->GetMaximumBin();
    for(int bin_number = 1; bin_number <= sieie_num_GJets_40to100_central->GetNbinsX(); bin_number++){
      ...
      if ((bin_number < maxbin_QCDsideband && j == 7) || (bin_number > maxbin_QCDsideband && j == 8)){
        signalGJets_40to100->SetBinContent(bin_number, signalGJets_40to100_sieieUp->GetBinContent(bin_number));
      }
      else if ((bin_number <= maxbin_QCDsideband && j == 8) || (bin_number >= maxbin_QCDsideband && j == 7)){
        signalGJets_40to100->SetBinContent(bin_number, signalGJets_40to100_sieieDown->GetBinContent(bin_number));
      }
    }
  }
  
  signalGJets_40to100->GetXaxis()->SetTitle("#sigma_{i#etai#eta}");
  signalGJets_40to100->GetYaxis()->SetTitle("Yield for 35.9 fb^{-1}");
  signalGJets_40to100->GetYaxis()->SetTitleOffset(1.8);
  signalGJets_40to100->SetTitle("");
  signalGJets_40to100->SetStats(0);
  signalGJets_40to100->SetLineWidth(2);
  ...
  TH1F* h_bkg_remainder = (TH1F*)sieie_num_QCDsideband_data->Clone("h_bkg_remainder");
  h_bkg_remainder->Add(signalGJets_40to100,-1.0); // Subtract signalGJets_40to100 from sieie_num_QCDsideband_data
  h_bkg_remainder->SetLineColor(kGreen);
  
  // Set all bins to > 0 for template fitting
  for(int bin = 1; bin <= h_bkg_remainder->GetNbinsX(); bin++){
    ...
    if(h_bkg_remainder->GetBinContent(bin) <= 1.0e-07)
      h_bkg_remainder->SetBinContent(bin,1.0e-07);
  }
  ...
  if (j == 0 && i >= 1 && i <= 5){
    ...
    leg->AddEntry(signalGJets_40to100,"Gen-matched #gamma+jets MC","L");
    leg->AddEntry(h_bkg_remainder,"Fake template","L");
    leg->SetFillStyle(0);
    leg->Draw();
  ...
  TH1D* h_qcd = (TH1D*)h_bkg_remainder->Clone();
  ...
  if (i >= 1 && i <= 5){
    ...
    h_bkg_remainder->Scale(fakevalue/(h_bkg_remainder->Integral()));
    ...
    h_bkg_remainder->SetLineColor(kGreen);
    h_bkg_remainder->SetLineWidth(3);
    h_bkg_remainder->SetLineStyle(kDashed);
    TH1D* h_gjet_temp = (TH1D*)h_bkg_remainder->Clone();
    ...
    leg->AddEntry(h_bkg_remainder,"Fake (data)","L");
    leg->SetFillStyle(0);
    leg->Draw();
...
void photonPurity_monojet_phopt()
{
