...
def plotVariable(samples,variable,initiate=True,blinded=False):
    ...
    if not blinded:
        ...
        if "ChNemPtFrac_" in samples.variable.variable or "recoil_" in samples.variable.variable:
            unclist = unclist + ["THEORY_"+unc for unc in ["NNLO_EWK","NNLO_Sud","NNLO_Miss"] + ["QCD_Scale","QCD_Proc","QCD_Shape","QCD_EWK_Mix"] ]
