...
#ifndef monoJetCommon_h
#define monoJetCommon_h
...
public :
  ...
  monoJetCommon(const char* inputFilename,const char* outputFilename,const char* fileRange);
  virtual ~monoJetCommon();
